...
export const businessInfo = pgTable("business_info", {
  ...
  scrapedContent: text("scraped_content").array(),
  scrapedTitles: text("scraped_titles").array(),
  scrapedUrls: text("scraped_urls").array(),
  scrapedAt: text("scraped_at").array(),
  ...
  documentContent: text("document_content").array(),
  documentTitles: text("document_titles").array(),
  documentExtractedAt: text("document_extracted_at").array(),
