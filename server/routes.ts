    ...
    try {
      ...
      if (includeTranscripts && callsData.length > 0) {
        ...
        for (const call of callsData) {
          ...
          // Summary
          if (call.summary) {
            doc.fontSize(10).fillColor('#4b5563').text('Summary: ', { continued: true });
            doc.fillColor('#374151').text(call.summary);
            doc.moveDown(0.5);
          }
      ...
      doc.fontSize(8).fillColor('#9ca3af').text(
        'Report generated by SkyIQ Call Intelligence Platform',
        50,
        doc.page.height - 50,
        { align: 'center' }
      );
